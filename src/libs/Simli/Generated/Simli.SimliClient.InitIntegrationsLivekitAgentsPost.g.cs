...
namespace Simli
{
    public partial class SimliClient
    {
        ...
        partial void PrepareInitIntegrationsLivekitAgentsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Simli.LiveKitInitializationRequest request);
        partial void ProcessInitIntegrationsLivekitAgentsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInitIntegrationsLivekitAgentsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Simli.InitIntegrationsLivekitAgentsPostResponse> InitIntegrationsLivekitAgentsPostAsync(

            global::Simli.LiveKitInitializationRequest request,
            global::Simli.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await InitIntegrationsLivekitAgentsPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Simli.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Simli.AutoSDKHttpResponse<global::Simli.InitIntegrationsLivekitAgentsPostResponse>> InitIntegrationsLivekitAgentsPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInitIntegrationsLivekitAgentsPostArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInitIntegrationsLivekitAgentsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Simli.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Simli.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InitIntegrationsLivekitAgentsPost",
                                methodName: "InitIntegrationsLivekitAgentsPostAsync",
                                pathTemplate: "\"/integrations/livekit/agents\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInitIntegrationsLivekitAgentsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Simli.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Simli.Error? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Simli.Error.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Simli.ApiException<global::Simli.Error>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInitIntegrationsLivekitAgentsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Simli.InitIntegrationsLivekitAgentsPostResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Simli.AutoSDKHttpResponse<global::Simli.InitIntegrationsLivekitAgentsPostResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Simli.InitIntegrationsLivekitAgentsPostResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Simli.InitIntegrationsLivekitAgentsPostResponse> InitIntegrationsLivekitAgentsPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Simli.LiveKitInitializationRequest
            {
            ...
            return await InitIntegrationsLivekitAgentsPostAsync(
                request: __request,
                requestOptions: requestOptions,
