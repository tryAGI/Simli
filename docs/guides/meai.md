...
The Simli SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package Simli
```
...
using var client = new SimliClient(
    apiKey: Environment.GetEnvironmentVariable("SIMLI_API_KEY")!);
